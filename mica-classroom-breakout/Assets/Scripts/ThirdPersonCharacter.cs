...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        public Text topRightGuideText;
        public Text topLeftGuideText;
        ...
        void OnControllerColliderHit(ControllerColliderHit hit)
        {
            ...
            if (hit.gameObject.name == "TopLeftSideQuestGuideCollisionCube")
            {
                topLeftGuideText.text = "After you finish all quest\ncollect the golden goblet";
            }

            if (hit.gameObject.name == "TopRightSideQuestGuideCollisionCube")
            {
                topRightGuideText.text = "After you finish all quest\ncollect the golden goblet";
            }
        }
